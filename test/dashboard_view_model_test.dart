...
void main() {
  ...
  late MockChatMessageRepository mockChatMessageRepo;
  ...
  setUp(() {
    ...
    TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        .setMockMethodCallHandler(const MethodChannel('nearby_connections'), (
    ...
    mockChatMessageRepo = MockChatMessageRepository();
  });
  ...
  group('DashboardViewModel - Shared Functionality', () {
    ...
    test('should clear all state on stopAll', () async {
      ...
      viewModel.availableDevices.add(
        Device(
          uuid: 'device-123',
          deviceName: 'Device',
          endpointId: 'ep-123',
